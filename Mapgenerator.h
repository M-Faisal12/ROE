...
struct TerrainSystemConfig
{
    ...
    // Model pools per biome
    std::vector<std::string> modelsPlains        = {"plains_01.glb","plains_02.glb","plains_03.glb"};
    std::vector<std::string> modelsSand          = {"sand_01.glb","sand_02.glb"};
    std::vector<std::string> modelsSandDunes     = {"dunes_01.glb","dunes_02.glb","dunes_03.glb"};
    std::vector<std::string> modelsWater         = {"water_01.glb","water_terrain.glb"};
    std::vector<std::string> modelsMountains     = {"mountain_01.glb","mountain_02.glb","mountain_05.glb"};
    std::vector<std::string> modelsSnow          = {"snow_01.glb","snow_02.glb"};
    std::vector<std::string> modelsSnowMountains = {"snow_mtn_01.glb","snow_mtn_02.glb"};
    std::vector<std::string> modelsFrozenWater   = {"ice_01.glb","ice_02.glb"};
};
